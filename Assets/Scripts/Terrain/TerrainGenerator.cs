...
public class TerrainGenerator : MonoBehaviour
{
    ...
    public Vector3[] islandEdges;
    public Vector3[] islandMasses;
    ...
    public void DrawMapInEditor()
    {
        ...
        {
            MeshData mesh = MeshGenerator.GenerateTerrainMesh(mapData.heightMap, terrainData.meshHeightMultiplier,
